      ...
      <div class="hero-content">
        ...
        <div class="hero-features">
          <div class="feature-item">
            ...
            <span>{{ t('home.featureDoctorTeam') }}</span>
          </div>
          <div class="feature-item">
            <CheckCircleOutlined class="feature-icon" />
            <span>{{ t('home.featureRealtimeConsultation') }}</span>
          </div>
          <div class="feature-item">
            <CheckCircleOutlined class="feature-icon" />
            <span>{{ t('home.featurePrivacyProtection') }}</span>
          </div>
        </div>
    ...
    <section class="statistics">
      ...
      <div class="stat-card">
        ...
        <div class="stat-info">
          ...
          <p>{{ t('home.statRooms') }}</p>
        </div>
      </div>
    </section>

    <section class="active-rooms">
      <h2>{{ t('home.roomSectionTitle') }}</h2>
      <p class="section-subtitle">{{ t('home.roomSectionSubtitle') }}</p>
      <div class="rooms-grid">
        ...
        >
          ...
          <div class="room-footer">
            <a-button type="primary" block>{{ t('common.enterRoom') }}</a-button>
          </div>
        </div>
      </div>
    </section>
